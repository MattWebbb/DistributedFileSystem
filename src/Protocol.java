...
public class Protocol {
	...
	// index status
	public final static String STORING = "STORE_IN_PROGRESS";
	public final static String STORED = "STORE_COMPLETE";
	public final static String REMOVING = "REMOVE_IN_PROGRESS";
